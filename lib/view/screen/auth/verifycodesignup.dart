import 'package:ecommercecoursenmmm/controller/auth/verfiycodesignup_controller.dart';
          ...
          builder: (controller) => HandlingDataRequest(
              ...
              widget: Container(
                ...
                child: ListView(children: [
                  ...
                  const CustomTextTitleAuth(text: "13"),
                  const SizedBox(height: 10),
                    CustomTextBodyAuth(
                      text:
                          "${"14".tr} ${controller.email}"),
                  ...
                  InkWell(onTap: (){
                    controller.reSend() ; 
                  },child: Center(child: Text("13".tr , style:const TextStyle(color: AppColor.primaryColor , fontSize: 20 ),)),)
                ]),
              ))),
    );
  }
